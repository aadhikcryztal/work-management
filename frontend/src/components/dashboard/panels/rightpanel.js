...
export default class rightpanel extends React.Component {
  ...
  componentDidMount = () => {
    this.setState({
      ...
      showAnnouncementForm : this.props.announcementForm
    });
  ...
  componentWillReceiveProps(nextprops) {
    this.setState({
      ...
      showAnnouncementForm : nextprops.announcementForm
    });
  }
  ...
  appendingMail = (event) => {
    if (event.keyCode === 188) {
      ...
      document.querySelector(".form-notifyto-inputbox").placeholder =
        "Add more";
      this.setState(
        {
          notify_to: [
    ...
    return (
      <div className="Rightpanel">
        {this.state.showAnnouncementForm ? (
          <div className="Rightpanel-form-card">
